    ...
    <div className={ classes.root }>
      ...
      <BrowserRouter>
        ...
        >
          ...
          <Divider/>
          <List>
            <ListItem button component={ NavLink } to="/" exact key="openMenuItem" activeClassName="Mui-selected">
              <ListItemIcon>
                <HomeIcon/>
              </ListItemIcon>
              <ListItemText primary="Open"/>
            </ListItem>
            <ListItem button component={ NavLink } to="/create" key="addMenuItem" activeClassName="Mui-selected">
              <ListItemIcon>
                <AddBoxIcon/>
              </ListItemIcon>
          ...
          <Divider/>
          <List>
            <ListItem button component={ NavLink } to="/about" key="aboutMenuItem" activeClassName="Mui-selected">
              <ListItemIcon>
                <InfoIcon/>
              </ListItemIcon>
